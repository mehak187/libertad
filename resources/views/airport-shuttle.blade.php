...
<body class="background_img">
                ...
                <div class="sidebar_content ms-md-4">
                    ...
                    <div class="sidebar_tab_content is-active">
                        <div class="container-fluid">
                            ...
                            @else
                                <div class="slider_popup py-4 mb-3 mt-3 mt-md-0 mx-2">
                                    <div class="d-flex">
                                        <h5 class="my-auto text-uppercase px-3" style="color: #E2BE4E;">Airport shuttle:
                                        </h5>
                                    </div>
                                    <div class="container-fluid">
                                        <form action="search_vehicle" method="GET">
                                            ...
                                            <div class="d-flex align-items-end">
                                                <div class="px-2 row align-items-center p-0 w-100">
                                                    <div class="col-11">
                                                        <div class="row input-container ">
                                                                <div class="col-3 ">
                                                                   <div class="w-100">
                                                                    <label for=""
                                                                    class="font-12 text-white">From</label>
                                                                    <input type="text" id="locationInput" value=""
                                                                        placeholder="Airport"
                                                                        class="form-control w-100 shadow-none bg-transparent text-white"
                                                                        name="from" required>
                                                                   </div>
                                                                </div>
                                                                <div class="mt-3 d-flex justify-content-center col-1">
                                                                    <span id="swap-icon" onclick="swapFields()">🔄</span>
                                                                </div>
                                                                <div class="col-3">
                                                                    <label for=""
                                                                        class="font-12 text-white">To</label>
                                                                    <input type="text" id="locationInput1" value=""
                                                                        placeholder="Hotel name"
                                                                        class="form-control w-100 shadow-none bg-transparent text-white"
                                                                        name="to" required>
                                                                </div>
                                                            {{-- </div> --}}
                                                            {{-- <div class="col-xl-6 d-sm-flex input-container "> --}}
                                                                <div class="col-2">
                                                                    <label for="" class="fs-12 text-white">Number of
                                                                        people</label>
                                                                    <input type="number" value="1"
                                                                        class="form-control w-100 text-white" name="people"
                                                                        id="" style="background-color: transparent;"
                                                                        required>
                                                                </div>
                                                                <div class="col-3">
                                                                    <label for=""
                                                                        class="fs-12  text-white">Date</label>
                                                                    <input type="date" class="form-control w-100 text-white"
                                                                        name="date" id=""
                                                            ...
                                                            <div class="">
                                                                <a href="{{ asset('vehicle') }}">
                                                                    <button class="btn p-0 mt-3"
                                                                        style="width: 1.5rem;">
                                                                        <img src="./imgs/review_button.png"
                                                                            class="" style="width: 2.6rem;"
                                                                            alt="">
                                                                    </button>
                                                                </a>
                                                            </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="w-100 mb-3">
                                                                                ...
                                                                                <p class="mb-0 fs-12 fw-bold ">
                                                                                    Vehicle type:
                                                                                    <span
                                                                                        class="searchable">{{ $vehicle2['vehicle'] }}</span>
                                                                                </p>
                                                                                <p class="mb-0 fs-12 fw-bold">No. of
                                                                                    people:
                                                                                    {{ $vehicle2['passengers'] }}
    ...
    <div class="custom-model res-model">
        <form action="/shuttlebooking" method="POST">
            ...
            <div class="px-3">
                <input type="number" value="" class="d-none vget" id="vgetValue" name="shuttle_id" readonly
                    required>
                <input type="number" value="" class="d-none pget" id="pgetValue" name="price" readonly
                    required>
                <input type="text" value="" class="d-none " id="peopleget" name="people" readonly
                    required>
                <input type="text" value="" class="d-none " id="typeget" name="type" readonly
                    required>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <select name="pick_time"
                        class="input time  w-100 text-secondary py-2 border border-1 rounded-3 px-2 shadow-none bg-white grey-bg"
                        id="arrivetime" required>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" id="locationInput2" name="pick_location" class="form-control shadow-none"
                        required>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <input type="address" id="locationInput3" name="drop_location" class="form-control shadow-none"
                        required>
                </div>
            </div>
            <div class="border-1 border-top mt-3 d-flex justify-content-end">
                <button type="submit" class="btn mybutton px-4 rounded-pill mt-3 mx-3 open-book">Confirm and
                    pay</button>
            </div>
        </form>
    </div>
        ...
        <div class="custom-model show-model">
            <form action="/shuttle_check" method="POST">
                ...
                <div class="px-3">
                    ...
                    <input type="" name="totalamount" value="{{ session('booking')->price }}" class="d-none"
                        readonly>
