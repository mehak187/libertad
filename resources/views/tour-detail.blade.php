            ...
            <div class="px-3">
                ...
                <div class="d-flex align-items-center form-control justify-content-between shadow-none font-12">
                    <input type="number" name="tprice" id="tpriceInput"
                        class="bg-transparent text-dark border-0 shadow-none font-12" value="{{ $stour['price'] }}"
                        readonly required>
                    <span>| USD</span>
                </div>
            </div>
    ...
    @if (session('bookingm'))
        <div class="custom-model book-model">
            <form name="booking" action="/savebooking" method="POST" enctype="multipart/form-data" class="mt-2">
                ...
                <input type="number" class="d-none" name="tour_id" value="{{ $stour->id }}">
                <input type="text" class="d-none" name="tour_name" value="{{ $stour->name }}">
                <input type="number" class="d-none" name="role" value="5" readonly>
