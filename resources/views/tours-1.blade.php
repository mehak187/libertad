                  ...
                  <div class="autoplay mb-3 px-1">
                    ...
                    <div class="slide mx-2">
                      <div class="container1 container1_2">
                        <img src="<?php echo asset('uploads/' . $city1['tourimg'])?>" alt="Avatar" class="image1 image1_2">
              ...
              <div class="row me-3">
                <div class="col-11">
                  <div class="autoplay mb-3 px-1">
                    ...
                    <div class="slide mx-2">
                      <div class="container1 container1_2">
                        <img src="<?php echo asset('uploads/' . $city2['tourimg'])?>" alt="Avatar" class="image1 image1_2">
          ...
          <div class="d-md-none d-block ps-3 mt-3 ms-1">
            ...
            <div>
              <a
                href="https://www.tripadvisor.com/Attraction_Review-g294201-d26208912-Reviews-Libertad_Del_Mundo-Cairo_Cairo_Governorate.html"><img
                  src="./imgs/social_icon_1.png" style="height: 40px; width: 40px;" alt=""></a>
              <a href="https://www.facebook.com/profile.php?id=100090555392220"><img src="./imgs/social_icon_2.png"
                  style="height: 40px; width: 40px;" alt=""></a>
              <a href="mailto:info@libertadelmundo.com"><img src="./imgs/social_icon_3.png"
                  style="height: 40px; width: 40px;" alt=""></a>
              <a href="mailto:info@libertadelmundo.com"><img src="./imgs/social_icon_4.png"
                  style="height: 40px; width: 40px;" alt=""></a>
              <a href="https://www.instagram.com/libertadelmundoofficial/?next=%2F"><img src="./imgs/social_icon_5.png"
                  style="height: 40px; width: 40px;" alt=""></a>
            </div>
          </div>
        </div>
