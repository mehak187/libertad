    ...
    <section class="main-tem">
        ...
        <div class="right-content p-0" style="background: #FAFBFE;">
            ...
            <div class="px-4 py-4 m-content px-lg-5">
                ...
                {{-- @if(isset($libertad) && count($libertad) > 0)
                    <form action="update_libertad" method="POST" enctype="multipart/form-data" class="mt-2">
                        @csrf
                    
                        <div class="form-field d-sm-flex  justify-content-between flex-wrap">
                            <div class="input-field w-100 dark-btn mt-4">
                                <label for="des" class="text-dark">Why Libertad Description</label>
                                <textarea id="des" class="w-100" placeholder="Description" name="des"></textarea>
                                @error('des')
                        ...
                        <h4 class="fs-6 mt-4">Add Images</h4>
                        ...
                        <div class="form-field d-sm-flex justify-content-between flex-wrap">
                            <div class="input-field dark-btn mt-4">
                                <input type="submit" value="Update libertad" class="w-100">
                            </div>
                        </div>
                    </form>
                @else --}}
