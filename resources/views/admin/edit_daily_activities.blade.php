...
<head>
    ...
    <title>Edit daily activities </title>
</head>
    ...
    <section class="main-tem">
        ...
        <div class="right-content p-0" style="background: #FAFBFE;">
            ...
            <div class="px-4 py-4 m-content px-lg-5">
                ...
                <h4 class="rounded-8 text-capitalize create-head px-3 py-3 mt-3">Edit daily activities</h4>
                <form action="/update_daily_activities" method="POST" enctype="multipart/form-data" class="mt-2">
                    @csrf
                    ...
                    <div class="form-field d-sm-flex justify-content-between flex-wrap">
                        <div class="input-field dark-btn mt-4">
                            <input type="submit" value="update daily activities" class="w-100">
                        </div>
                    </div>
                </form>
            </div>
