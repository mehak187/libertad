        ...
        <div class="right-content p-0" style="background: #FAFBFE;">
            ...
            <div class="px-4 py-4 m-content px-lg-5">
              <div class="d-flex justify-content-end">
                <a href="/add_city_tours" class="bg-yellow text-dark py-2 px-3 text-decoration-none rounded-3">Add City Tour</a>
            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{"city_tour_details/" .$citytour['id'] }}" class="bg-success d-inline-block text-white text-decoration-none py-2 my-1 px-3 rounded-3">View Details</a>
                                <a href="{{"edit_city_tours/" .$citytour['id'] }}" class="bg-primary d-inline-block text-white text-decoration-none py-2 my-1 px-3 rounded-3">Edit</a>
                                <a href="{{"delete_city_tour/" .$citytour['id'] }}" class="bg-danger d-inline-block text-white text-decoration-none py-2 my-1 px-3 rounded-3">Delete</a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
