    ...
    <section class="main-tem">
        ...
        <div class="right-content p-0" style="background: #FAFBFE;">
            ...
            <div class="px-4 py-4 m-content px-lg-5">
                ...
                <h4 class="rounded-8 text-capitalize create-head px-3 py-3 mt-3">Add city tour</h4>
                @if (count($cities) > 0)
                    <form action="save_citytour" method="POST" enctype="multipart/form-data" class="mt-2">
                        @csrf
                        ...
                        <div class="form-field d-sm-flex justify-content-between flex-wrap">
                            <div class="input-field w-100 dark-btn mt-4">
                                <textarea class="w-100" placeholder="Tour highlights" name="sight_seeing">{{old('sight_seeing')}}</textarea>
                                @error('sight_seeing')
                                    <span class="error text-danger">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-field d-sm-flex justify-content-between flex-wrap">
                            <div class="input-field w-100 dark-btn mt-4">
                                <textarea class="w-100" placeholder="exclude" name="exclude">{{old('exclude')}}</textarea>
                                @error('exclude')
                                    <span class="error text-danger">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="form-field d-sm-flex justify-content-between flex-wrap">
                            <div class="input-field dark-btn mt-4">
                                <label for="book_img" class="text-dark fs-bold">City tour image</label>
                        ...
                        <div class="form-field d-sm-flex justify-content-between flex-wrap">
                            <div class="input-field dark-btn mt-4">
                                <input type="submit" value="Save city tour" class="w-100">
                            </div>
                        </div>
                    </form>
                @else
