...
<body class="background_img">
    ...
    <section class="main-tem">
        ...
        <div class="right-content back_img pt-3 pb-5">
            <div class="outer_sidebar px-md-4 pb-5">
                                            ...
                                            <div class="map-width position-relative">
                                                ...
                                                <div class="dot" data-message="Message 10" id="dot9">
                                                    <div class="position-img9">
                                                        <img src="./imgs/hurghada.png" alt=""
                                                            class="city-img">
                                                        <p class="m-0 mt-2 text-white text-center font-12">Giza-El
                                                            Gouna
                                                        </p>
                                                    </div>
                                                </div>
                                                        ...
                                                        @if (count($cities) > 0)
                                                            ...
                                                            <div class="button_border rounded-4 rounded-pill mt-3">
                                                                <button type="submit"
                                                                        ...
                                                                        Plan the Trip
                                                                        <img src="./imgs/button_errow.png"
                                                                            style="width: 30px;" class="ps-2"
                                                                            alt="">
                                                                    </button>
                                                            </div>
                                                        @else
