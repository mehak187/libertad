        ...
        <form action="/book1" method="POST">
            ...
            <div class="px-3">
               ...
               <div class="d-flex align-items-center form-control justify-content-between shadow-none font-12">
                    <input type="number" name="tprice" id="tpriceInput" class="bg-transparent text-dark border-0 shadow-none font-12"
    ...
    @if (session('bookingm'))
        <div class="custom-model book-model">
            <form name="booking" action="/savebooking" method="POST" enctype="multipart/form-data" class="mt-2">
                ...
                <input type="number" class="d-none" name="tour_id" value="{{ $hotel->id }}">
                <input type="text" class="d-none" name="tour_name" value="{{ $hotel->name }}">
                <input type="number" class="d-none" name="role" value="3" readonly>
        ...
        <div class="custom-model show-model">
            <form action="/check" method="POST">
                ...
                <div class="px-3">
                    ...
                    <input type="text" name="totalamount" value="{{ session('booking')->t_price }}" class="d-none" readonly>
