                ...
                <div class="d-flex align-items-center gap-1 d-md-none d-block ">
                    @if (auth()->check())
                        <div class="my-auto d-md-none d-block position-relative">
                            <a class="text-white text-decoration-none ms-2"
                                style="background-color: transparent; border-style: none;" href="{{ route('logout') }}"
                        ...
                        <div class="my-auto">
                            <div class="dropdown my-drop">
                                ...
                                <div class="dropdown-menu px-3 pt-4 pb-2 sign_in_dropdown px-4 "
                                    id="register-mbl-show">
                                    <form method="POST" action="{{ route('register') }}">
                                        @csrf
                                        <input type="number" class="form-control mb-2 d-none" name="role"
                                            value="1" readonly>
                                        <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <input type="text"
                                                class="form-control mb-2 @error('lastname') is-invalid @enderror"
                                        ...
                                        <div>
                                            <button type="submit"
                                                class="input w-100 border-0 py-2 form-control sign_in_button mb-2">
                                                {{ __('Register') }}
                                            </button>
                                        </div>
                                    </form>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <a href="{{ asset('/') }}"
                                        ...
                                        <img src="{{ asset('imgs/logo_text.png') }}" alt="logo"
                                            class="img-logo">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu px-3 pt-4 pb-2 sign_in_dropdown parent"
                                                    ...
                                                    <form method="POST" action="{{ route('login') }}">
                                                        ...
                                                        <div>
                                                            <input type="email"
                                                                class="mb-2 form-control bg-white @error('email') is-invalid @enderror"
                                                        ...
                                                        <div>
                                                            <input type="password"
                                                                class="form-control bg-white mb-4 @error('password') is-invalid @enderror"
                                                                placeholder="password" name="password" required
                                                                autocomplete="current-password">
                                                            @error('password')
                                                                <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <div>
                                                            ...
                                                            @if (Route::has('password.request'))
                                                                ...
                                                                <p class="mb-0 text-end fs-14 text-white"
                                                                    id="reset-desktop" style="cursor: pointer;">Forget
                                                                    password</p>
                                                            @endif
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="dropdown my-drop">
                                                ...
                                                <div class="dropdown-menu px-3 pt-4 pb-2 sign_in_dropdown px-4"
                                                    ...
                                                    <form method="POST" action="{{ route('register') }}">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <h5 class="mb-3" style="color: #B38029;">Register NOW
                                                            </h5>
                                        ...
                                        <script type="text/javascript">
                                            function googleTranslateElementInit() {
                                                new google.translate.TranslateElement({
                                                    ...
                                                    autoDisplay: false,
                                                    defaultLanguage: 'en' // Display English as default
